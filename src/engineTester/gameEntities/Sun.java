...
public class Sun extends Light {
	...
	private static final Vector2f MORNING_COLOR[] 	= { new Vector2f(1.10f, 1.50f), new Vector2f(0.75f, 1.50f), new Vector2f(0.15f, 1.50f) };
	private static final Vector2f NOON_COLOR[] 		= { new Vector2f(1.50f, 1.50f), new Vector2f(1.50f, 1.50f), new Vector2f(1.50f, 1.50f) };
	private static final Vector2f AFTERNOON_COLOR[] = { new Vector2f(1.50f, 1.50f), new Vector2f(1.50f, 1.00f), new Vector2f(1.50f, 0.00f) };
	private static final Vector2f TWILIGHT_COLOR[] 	= { new Vector2f(1.50f, 0.0f),  new Vector2f(1.00f, 0.0f), new Vector2f(0.00f, 0.0f) };
