...
void main(void) {
	...
	float brightness = max(nDotProd, 0.2);	// Ambient light made by ensuring difuse light is above 0.2
	...
	vec4 fragmentColor = vec4(diffuseLight, 1.0) * textureColor + vec4(specularLight, 1.0);
